/**
 * Port of src/lib/habits/types.ts from the Expo app.
 *
 * The shape is byte-identical so a JSON export from the mobile app can be
 * imported into the PWA without any field mapping (see §8 of the plan).
 */
...
export type Habit = {
  ...
  color: string;
  frequency: Frequency;
  /** IDs returned by the legacy native scheduler — preserved for cross-platform import. */
