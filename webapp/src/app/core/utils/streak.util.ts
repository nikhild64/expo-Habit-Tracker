/**
 * Streak + strength helpers — port of src/lib/habits/streak.ts.
 *
 * Every function here is pure: no DOM, no fetch, no platform-specific APIs.
 * Tests use the exact same fixtures as the mobile app (see *.spec.ts).
 */
